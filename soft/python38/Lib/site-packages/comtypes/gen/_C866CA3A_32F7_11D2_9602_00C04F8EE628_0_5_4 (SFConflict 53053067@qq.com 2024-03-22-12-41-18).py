...
__all__ = [
    'SRERequestUI', 'SpeechTokenContext', 'SPPS_Verb',
    'eLEXTYPE_PRIVATE9', 'Library', 'ISpNotifySource', 'SPAS_CLOSED',
    'SVP_1', 'SVPAlert', 'DISPID_SRCEAdaptation',
    'SPRS_ACTIVE_USER_DELIMITED', 'eLEXTYPE_PRIVATE1',
    'SPSHORTCUTTYPE', 'SAFT12kHz16BitMono', 'SPBO_PAUSE',
    'DISPID_SPIProperties', 'SPVPRI_NORMAL', 'DISPID_SABIBufferSize',
    'SPSMF_UPS', 'SPEI_HYPOTHESIS', 'SPGS_DISABLED',
    'DISPID_SVDisplayUI', 'SVP_21', 'DISPID_SPARecoResult',
    'DISPID_SRState', 'SpeechRecoContextState', 'SVSFDefault',
    'DISPID_SPPs_NewEnum', 'ISpeechBaseStream', 'DISPID_SRCBookmark',
    'DISPID_SPEAudioTimeOffset', 'SPBINARYGRAMMAR', 'SVP_6',
    'eLEXTYPE_RESERVED6', 'eLEXTYPE_PRIVATE12', 'SAFTGSM610_8kHzMono',
    'DISPID_SGRsDynamic', 'eLEXTYPE_PRIVATE5', 'SPINTERFERENCE',
    'ISpeechRecoResult', 'SVP_17', 'SpeechUserTraining',
    'SpeechGrammarTagWildcard', 'DISPID_SOTCSetId',
    'SpPhoneticAlphabetConverter', 'SPEI_INTERFERENCE',
    'SAFT12kHz8BitMono', 'SGRSTTWord', 'SPEI_RECOGNITION',
    'SPVOICESTATUS', 'SPCT_SUB_COMMAND', 'SSSPTRelativeToEnd',
    'SLODynamic', 'DISPID_SASFreeBufferSpace', 'DISPID_SVSPhonemeId',
    'DISPID_SLPType', 'SPINTERFERENCE_NOISE', 'SpeechRuleAttributes',
    'SAFT16kHz8BitMono', 'DISPID_SPACommit', 'DISPID_SAFType',
    'ISpeechRecoResult2', 'DISPID_SPIEnginePrivateData',
    'ISpeechAudioFormat', 'SPPS_RESERVED1', 'SP_VISEME_8',
    'DISPID_SpeechPhraseProperties', 'SAFT16kHz16BitMono',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SDKDeleteKey',
    'DISPID_SRCVoice', 'eLEXTYPE_PRIVATE8', 'SPRECOSTATE',
    'SpeechVoiceSkipTypeSentence', 'eLEXTYPE_PRIVATE4',
    'SPAUDIOSTATE', 'DISPID_SLPPhoneIds', 'SpeechLoadOption',
    'SPINTERFERENCE_TOOSLOW', 'SLTApp', 'SpMMAudioOut',
    'DISPID_SRDisplayUI', 'DISPID_SRGCmdLoadFromResource',
    'ISpEventSource', 'SAFT8kHz16BitStereo', 'SpeechDiscardType',
    'DISPID_SpeechRecoContext', 'SP_VISEME_7',
    'DISPID_SVSLastBookmarkId', 'SVSFParseAutodetect',
    'DISPID_SRGDictationUnload', 'SAFT48kHz8BitMono', 'IEnumString',
    'ISpeechVoice', 'DISPID_SGRsFindRule', 'DISPID_SDKGetBinaryValue',
    'DISPID_SPRules_NewEnum', 'SDA_No_Trailing_Space', 'SGRSTTRule',
    'ISpeechPhraseProperties', 'DISPID_SGRSTPropertyName',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SASState', 'SPEI_MIN_TTS',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SGDSActiveUserDelimited', 'ISpRecognizer3', 'SECFIgnoreKanaType',
    'eLEXTYPE_PRIVATE15', 'SREPhraseStart',
    'DISPID_SRCCmdMaxAlternates', 'SAFTCCITT_uLaw_11kHzMono',
    'SpNotifyTranslator', 'SAFT32kHz8BitStereo',
    'DISPID_SDKSetStringValue', 'DISPID_SCSBaseStream', 'DISPIDSPTSI',
    'Speech_Max_Pron_Length', 'SpeechGrammarState', 'SVSFVoiceMask',
    'SAFT24kHz16BitStereo', 'SPEI_END_SR_STREAM',
    'SpeechInterference', 'DISPID_SREmulateRecognition',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRCEEnginePrivate',
    'SpeechRecoProfileProperties', 'SVP_15',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SVPause',
    'DISPID_SRCESoundStart', 'SPXMLRESULTOPTIONS', 'SPSLMA',
    'SPPARTOFSPEECH', 'SVSFUnusedFlags', 'ISpObjectWithToken',
    'DISPID_SPEsCount', 'SpeechAudioFormatType',
    'DISPID_SGRSTNextState', 'DISPID_SVSInputSentencePosition',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRRTLength', 'SASClosed',
    'SVPOver', 'SDKLCurrentConfig', 'SPEI_SENTENCE_BOUNDARY',
    'SPWORDPRONOUNCEABLE', 'SREBookmark',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPAS_PAUSE',
    'SPSModifier', 'DISPID_SLPsCount', 'ISpeechCustomStream',
    'SREAudioLevel', 'SRSActiveAlways', 'DISPID_SVEWord',
    'DISPID_SPIReplacements', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SOTGetAttribute', 'SREAllEvents', 'eLEXTYPE_USER',
    'DISPID_SRCResume', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SPEI_SR_AUDIO_LEVEL', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRRAlternates',
    'DISPID_SpeechRecoResult2', 'SpLexicon',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SRRGetXMLErrorInfo',
    'SRAImport', 'SGLexical', 'DISPID_SpeechLexiconWords',
    'DISPID_SWFEBitsPerSample', 'ISpeechObjectTokens',
    'SPEI_RESERVED1', 'SECHighConfidence',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRCEAudioLevel',
    'SPCATEGORYTYPE', 'SVP_18', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SpeechWaveFormatEx', 'SPEI_PHRASE_START',
    'DISPID_SLWWord', 'SAFT32kHz16BitStereo', 'SPEI_END_INPUT_STREAM',
    'eLEXTYPE_RESERVED10', 'DISPID_SLPLangId', 'DISPID_SASetState',
    'SAFT11kHz16BitMono', 'DISPID_SpeechRecoResultTimes',
    'SRESoundEnd', 'DISPID_SRCState', 'SVP_14', 'SVESentenceBoundary',
    'SPEVENTENUM', 'eLEXTYPE_PRIVATE20', 'DISPID_SpeechPhraseRules',
    'SpeechStreamFileMode', 'SpObjectToken', 'SECFIgnoreCase',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SRSCurrentStreamNumber',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpNotifySink',
    'SPCT_DICTATION', 'SpFileStream', 'SP_VISEME_21', 'ISpVoice',
    'DISPID_SWFEFormatTag', 'ISpeechLexiconWords',
    'ISpeechRecoResultTimes', 'SRSEIsSpeaking', 'ISpeechObjectToken',
    'DISPID_SGRs_NewEnum', 'SPFM_CREATE',
    ...
    'DISPID_SVEVoiceChange', 'DISPID_SPPValue', 'SPEI_ADAPTATION',
    'SpeechWordPronounceable', 'DISPID_SGRSAddRuleTransition',
    'SDTProperty', 'DISPID_SOTId', 'DISPID_SpeechLexiconWord',
    'SpeechTokenKeyFiles', 'SpStreamFormatConverter', 'DISPID_SOTCId',
    'SpeechAudioFormatGUIDWave', 'SpeechCategoryRecognizers',
    'SRADynamic', 'SDTPronunciation', 'DISPID_SpeechVoiceStatus',
    'DISPID_SRSAudioStatus', 'Speech_StreamPos_RealTime', 'SRARoot',
    'DISPID_SRGId', 'DISPID_SpeechVoiceEvent',
    'eLEXTYPE_USER_SHORTCUT', 'STCLocalServer', 'STSF_FlagCreate',
    ...
    'DISPID_SVGetProfiles', 'DISPID_SRRAudioFormat',
    'SAFTGSM610_44kHzMono', 'SpSharedRecoContext', 'SP_VISEME_9',
    'ISpeechAudioBufferInfo', 'SpeechPropertyResourceUsage',
    'SECFIgnoreWidth', 'SpResourceManager', 'DISPID_SGRSTRule',
    'SVEViseme', 'ISpStreamFormat', 'SAFTCCITT_ALaw_8kHzStereo',
    'SP_VISEME_18', 'SPSHT_EMAIL', 'UINT_PTR', 'ISpResourceManager',
    'SDA_One_Trailing_Space', 'SREStateChange',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SDKEnumValues',
    'SPAUDIOSTATUS', 'STSF_AppData', 'WAVEFORMATEX',
    'DISPID_SOTsCount', 'DISPID_SpeechObjectTokens',
    'SpeechEngineConfidence', 'SVSFNLPMask', 'SREAdaptation',
    'DISPID_SBSSeek', 'SSFMCreate', 'typelib_path', 'DISPID_SPIRule',
    'ISpeechGrammarRuleState', 'DISPID_SPPFirstElement',
    'IEnumSpObjectTokens', 'SP_VISEME_0', 'SAFT16kHz8BitStereo',
    'SGDSActiveWithAutoPause', 'eLEXTYPE_PRIVATE3', 'SRTSMLTimeout',
    'DISPID_SVSCurrentStreamNumber', 'ISpObjectToken', 'DISPID_SGRId',
    'ISpeechWaveFormatEx', 'SREStreamStart',
    '_ISpeechRecoContextEvents', 'SAFT12kHz8BitStereo',
    'DISPID_SFSOpen', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SGRSTsCount', 'SRSInactive', 'eLEXTYPE_MORPHOLOGY',
    'SPPHRASEELEMENT', 'SPSERIALIZEDRESULT',
    'SPEI_START_INPUT_STREAM', 'ISpObjectTokenCategory',
    'DISPID_SVAudioOutput', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpMMAudioEnum', 'SPLEXICONTYPE', 'SRAExport',
    'SpeechCategoryAppLexicons', 'SAFT24kHz8BitStereo',
    'ISpeechPhraseInfo', 'SpeechVoiceCategoryTTSRate',
    'SVSFParseSsml', 'STCAll', 'SWTDeleted', 'DISPID_SPPsCount',
    'SVSFPersistXML', 'SPFM_OPEN_READONLY', 'SGRSTTTextBuffer',
    'DISPID_SVEStreamStart', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPIDSPTSI_SelectionOffset', 'SPADAPTATIONRELEVANCE',
    'DISPID_SDKGetStringValue', 'SGLexicalNoSpecialChars',
    'ISpeechPhoneConverter', 'SDTLexicalForm', 'DISPID_SPAsItem',
    'DISPIDSPTSI_SelectionLength', 'SAFTADPCM_22kHzMono',
    'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRRTOffsetFromStart', 'SVP_8', 'SRSEDone',
    'DISPID_SPIAudioStreamPosition', 'SDTAlternates',
    'SAFT24kHz8BitMono', 'ISpeechAudio', 'SpNullPhoneConverter',
    'SRTEmulated', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SVSInputSentenceLength', 'DISPID_SVAudioOutputStream',
    'SPRECOGNIZERSTATUS', 'SpeechGrammarTagUnlimitedDictation',
    'SPVPRIORITY', 'SPEI_MIN_SR', 'SREPropertyNumChange',
    'DISPID_SPEsItem', 'DISPID_SRGReset', 'SVSFParseSapi',
    'SPRS_ACTIVE', 'DISPID_SABIEventBias', 'SSFMOpenReadWrite',
    'eLEXTYPE_PRIVATE19', 'DISPID_SPPChildren', 'SPSTREAMFORMATTYPE',
    'DISPID_SAFGuid', 'SAFTNoAssignedFormat',
    'DISPID_SPPNumberOfElements', 'ISpRecoGrammar2', 'SPPS_Unknown',
    'DISPID_SpeechRecognizerStatus', 'ISpeechMMSysAudio',
    'SpInProcRecoContext', 'DISPID_SRSClsidEngine',
    'DISPID_SWFEExtraData', 'SPFM_NUM_MODES', 'SPEI_RESERVED5',
    'SP_VISEME_19', 'SASStop',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SPEs_NewEnum',
    'SITooLoud', 'SVEStartInputStream', 'DISPID_SPEDisplayAttributes',
    'DISPID_SOTsItem', 'SGSDisabled', 'SGRSTTWildcard',
    'SPPS_Noncontent', 'DISPID_SOTCGetDataKey',
    'DISPID_SRRSetTextFeedback', 'SpeechTokenShellFolder',
    'ISpeechGrammarRuleStateTransition', 'SPXRO_SML', 'ISpRecoResult',
    'DISPID_SLWPronunciations', 'SPSHT_NotOverriden',
    'SPSHORTCUTPAIR', 'DISPID_SpeechPhoneConverter',
    'DISPIDSPTSI_ActiveOffset', 'SPEI_SOUND_START',
    'eLEXTYPE_PRIVATE14', 'eLEXTYPE_APP', 'Speech_StreamPos_Asap',
    'SAFT32kHz16BitMono', 'ISpPhoneConverter',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SPRFirstElement',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SLPPartOfSpeech',
    'SP_VISEME_13', 'SWPUnknownWordUnpronounceable',
    'DISPID_SPRuleFirstElement', 'DISPID_SPRulesItem',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPEI_START_SR_STREAM',
    'DISPID_SpeechMemoryStream', 'ISpeechGrammarRules', 'SPEVENT',
    'SLTUser', 'SVP_20', 'SAFT11kHz16BitStereo',
    'DISPID_SRCEPropertyNumberChange', 'SAFT22kHz8BitStereo',
    'SP_VISEME_11', 'DISPID_SGRSTs_NewEnum', 'SVP_19',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SPIGrammarId',
    'SPPS_RESERVED3', 'SAFT24kHz16BitMono', 'SAFTADPCM_44kHzMono',
    'SPEI_RESERVED6', 'SPAO_RETAIN_AUDIO', 'ISpeechPhraseAlternate',
    'SRERecognition', 'ISequentialStream',
    'ISpeechPhraseReplacements', 'SpStream', 'SRSActive',
    'DISPID_SRCEventInterests', 'SGDisplay', 'eLEXTYPE_PRIVATE11',
    'DISPIDSPRG', 'SRERecoOtherContext', 'DISPID_SRRSaveToMemory',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRRTimes', 'SREInterference',
    ...
    'DISPID_SLWsItem', 'ISpGrammarBuilder', 'SPPS_LMA', 'SPAS_STOP',
    'SVEVoiceChange', 'DISPID_SPRsItem', 'SVEEndInputStream',
    'DISPID_SGRsAdd', 'SPCT_SLEEP', 'ISpeechPhraseElements',
    'DISPID_SVEventInterests', 'DISPID_SPCIdToPhone', 'SPAO_NONE',
    'DISPID_SRCCreateResultFromMemory', 'ISpeechRecoContext',
    'SPSEMANTICERRORINFO', 'SP_VISEME_3', 'DISPID_SRGCommit',
    'SAFT16kHz16BitStereo', 'ISpPhrase', 'SPTEXTSELECTIONINFO',
    'DISPID_SGRName', 'DISPID_SVVoice', 'STCInprocHandler',
    'ISpPhraseAlt', 'DISPID_SRCPause', 'SVSFParseMask',
    'DISPID_SOTDisplayUI', 'SRTExtendableParse',
    'SPRECOCONTEXTSTATUS', 'DISPID_SLWs_NewEnum', 'SPWT_DISPLAY',
    '_ISpeechVoiceEvents', 'DISPID_SLPSymbolic', 'SPGRAMMARSTATE',
    'DISPID_SpeechRecoContextEvents', 'SpeechPropertyAdaptationOn',
    'SDA_Consume_Leading_Spaces', 'DISPID_SRCERecognition',
    '__MIDL_IWinTypes_0009', 'DISPID_SPCLangId', 'eLEXTYPE_PRIVATE6',
    'DISPID_SGRClear', 'DISPID_SPEAudioStreamOffset',
    'SAFT22kHz8BitMono', 'DISPID_SFSClose', 'SPINTERFERENCE_TOOQUIET',
    'eLEXTYPE_PRIVATE10', 'SpeechRecognizerState', 'SP_VISEME_20',
    'DISPID_SDKGetlongValue', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SOTCategory', 'SPWORD', 'IStream',
    'DISPID_SASNonBlockingIO', 'DISPID_SOTSetId', 'SPPHRASEPROPERTY',
    'SpeechVoiceSpeakFlags', 'SPEI_RESERVED3', 'SAFT48kHz16BitStereo',
    'DISPID_SPRuleConfidence', 'DISPID_SRCEInterference',
    'DISPID_SADefaultFormat', 'DISPID_SRCreateRecoContext', 'SPSVerb',
    'DISPID_SGRsCommitAndSave', 'SpPhraseInfoBuilder',
    'DISPID_SpeechBaseStream', 'SSTTDictation',
    'DISPID_SRCERecognizerStateChange', 'SpeechPartOfSpeech',
    'SpeechRetainedAudioOptions', 'SPFILEMODE',
    'Speech_Max_Word_Length', 'SASPause',
    'ISpeechLexiconPronunciations', 'DISPID_SpeechMMSysAudio',
    'DISPID_SPPEngineConfidence', 'DISPID_SRAudioInput',
    'SECFEmulateResult', 'SpeechRecognitionType',
    'DISPID_SAFGetWaveFormatEx', 'SAFTADPCM_22kHzStereo',
    'SPSERIALIZEDPHRASE', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SPRuleParent', 'DISPID_SpeechPhraseRule',
    'DISPID_SDKDeleteValue', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRCEBookmark', 'SPEI_SR_BOOKMARK', 'STCInprocServer',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpMMAudioIn',
    'SAFT8kHz8BitStereo', 'SPEI_TTS_BOOKMARK', 'SPSUnknown',
    'DISPID_SpeechPhraseBuilder', 'eWORDTYPE_ADDED', 'SpWaveFormatEx',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SPEActualConfidence',
    'SAFTADPCM_11kHzStereo', 'DISPID_SRGetFormat',
    'DISPID_SMSALineId', 'SDTAudio', 'ISpeechResourceLoader',
    'DISPID_SGRSTType', 'DISPID_SVGetAudioInputs', 'ISpDataKey',
    'eLEXTYPE_PRIVATE2', 'SpeechLexiconType', 'SpeechAddRemoveWord',
    'SpeechDisplayAttributes', 'DISPID_SGRAddState',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SpeechRecoResult',
    'DISPID_SDKSetLongValue', 'ISpEventSink', 'DISPID_SGRsCommit',
    'DISPID_SRRGetXMLResult', 'SPWAVEFORMATTYPE',
    'DISPID_SWFEBlockAlign', 'DISPID_SVEEnginePrivate', 'SPEI_VISEME',
    'SP_VISEME_10', 'SAFTCCITT_uLaw_44kHzMono',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRSetPropertyNumber',
    'SPCONTEXTSTATE', 'DISPID_SOTRemove', 'SBONone',
    'DISPID_SASCurrentSeekPosition', 'SGSExclusive',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SPISaveToMemory', 'SBOPause', 'SGPronounciation',
    'DISPID_SRGetPropertyNumber', 'DISPID_SVSkip', 'DISPID_SPPName',
    'SPEI_PHONEME', 'DISPID_SRGSetWordSequenceData', 'SVEPrivate',
    'SpShortcut', 'DISPID_SpeechPhraseReplacement',
    'SPDKL_CurrentUser', 'SAFT44kHz16BitStereo', 'SPLO_DYNAMIC',
    'SPAR_Medium', 'SVP_4', 'SPSFunction', 'SECLowConfidence',
    'DISPID_SPAsCount', 'SpeechSpecialTransitionType',
    'SpeechCategoryVoices', 'DISPID_SPRuleChildren', 'SPRST_ACTIVE',
    'ISpeechRecognizer', 'DISPID_SPERetainedSizeBytes',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SVGetAudioOutputs', 'SpeechFormatType',
    'ISpeechPhraseRules', 'SRCS_Enabled', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRCSetAdaptationData',
    'SRSInactiveWithPurge', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SRGetRecognizers', 'SPBO_TIME_UNITS',
    'ISpeechAudioStatus', 'SPRST_INACTIVE_WITH_PURGE',
    'SpeechRunState', 'DISPID_SGRInitialState',
    'DISPID_SABufferNotifySize', 'SPVPRI_ALERT', 'SECFDefault',
    'SPDKL_LocalMachine', 'DISPID_SPEEngineConfidence',
    'SPEI_SOUND_END', 'SAFTExtendedAudioFormat', 'ISpeechLexicon',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SVSRunningState', 'SVP_16',
    'SpeechBookmarkOptions', 'SRAInterpreter',
    'DISPID_SVIsUISupported', 'SpObjectTokenCategory', 'SGDSActive',
    'DISPID_SVRate', 'eLEXTYPE_PRIVATE18',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SRCEEndStream',
    'SPEI_MAX_SR', 'DISPID_SPIRetainedSizeBytes',
    'SpeechCategoryAudioOut', 'SAFTADPCM_8kHzMono',
    'SpeechTokenKeyAttributes', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SRGRules', 'SRCS_Disabled', 'SREStreamEnd',
    'DISPID_SPRNumberOfElements', 'DISPID_SLWType', 'SVF_Emphasis',
    'DISPID_SGRSTPropertyId', 'ISpeechGrammarRule',
    'DISPID_SpeechAudio', 'ISpRecoContext', 'SFTSREngine',
    'DISPID_SGRSTText', 'eLEXTYPE_PRIVATE13', 'SP_VISEME_5',
    'ISpStream', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SDKCreateKey',
    'DISPID_SPPParent', 'SVF_None', 'ISpRecoContext2',
    'DISPID_SRCRecognizer', 'SpCompressedLexicon',
    'DISPID_SGRAddResource', 'DISPID_SLPsItem', 'DISPID_SVResume',
    'DISPID_SLWsCount', 'SVP_5', 'DISPID_SPERequiredConfidence',
    'DISPID_SOTMatchesAttributes', 'SpeechRegistryLocalMachineRoot',
    'SVSFNLPSpeakPunc', 'SPEVENTSOURCEINFO', 'ISpRecognizer2',
    'DISPID_SLPs_NewEnum', 'DISPID_SVSInputWordLength', 'SPRULESTATE',
    'SPEI_MAX_TTS', 'SVSFPurgeBeforeSpeak', 'SRTAutopause',
    'SPDKL_DefaultLocation', 'SGDSInactive', 'SpeechAudioProperties',
    'SRAONone', 'DISPID_SDKOpenKey', 'SpPhoneConverter',
    'SPSSuppressWord', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SVSInputWordPosition', 'SAFT48kHz8BitStereo',
    'DISPID_SPRText', 'DISPID_SAStatus', 'ISpeechRecoGrammar',
    'DISPID_SMSSetData', 'SpInprocRecognizer',
    'DISPID_SRGCmdSetRuleState', 'SSSPTRelativeToCurrentPosition',
    'SPWF_SRENGINE', 'SWPUnknownWordPronounceable',
    'SpeechVisemeFeature', 'DISPID_SMSGetData', 'SPRECORESULTTIMES',
    'DISPID_SLRemovePronunciation', 'DISPID_SPEDisplayText',
    '_RemotableHandle', 'SAFTGSM610_22kHzMono', 'SpAudioFormat',
    'DISPID_SPEPronunciation', 'SPCS_DISABLED', 'SPCS_ENABLED',
    'DISPID_SRCEStartStream', 'SVPNormal', 'SRAORetainAudio',
    'DISPID_SpeechPhraseInfo', 'eLEXTYPE_RESERVED7',
    ...
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SPAs_NewEnum',
    'SPEI_TTS_PRIVATE', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SpeechPhraseElements', 'SPGS_ENABLED', 'LONG_PTR',
    'DISPID_SVSpeak', 'SAFTCCITT_uLaw_22kHzMono',
    'tagSPTEXTSELECTIONINFO', 'SAFTADPCM_11kHzMono',
    'DISPID_SVStatus', 'STSF_LocalAppData', 'DISPID_SPIGetText',
    'SpeechRecoEvents', 'DISPID_SPRuleId', 'DISPID_SVEViseme',
    'DISPID_SLGenerationId', 'SPPS_NotOverriden', 'SPWT_LEXICAL',
    'DISPID_SRGState', 'SVSFIsFilename', 'ISpStreamFormatConverter',
    'DISPID_SAFSetWaveFormatEx', 'SAFT11kHz8BitStereo',
    'SDKLCurrentUser', 'DISPID_SRRecognizer', 'SPSNotOverriden',
    'SAFT12kHz16BitStereo', 'ISpXMLRecoResult', 'SP_VISEME_1',
    'SPGRAMMARWORDTYPE', 'DISPID_SPRuleNumberOfElements',
    'ISpMMSysAudio', 'ISpeechPhraseProperty',
    'DISPID_SpeechCustomStream', 'ISpeechLexiconPronunciation',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SPILanguageId',
    'DISPID_SOTDataKey', 'DISPID_SPERetainedStreamOffset',
    'SECNormalConfidence', 'SVEAudioLevel', 'ISpeechPhraseRule',
    'SpMemoryStream', 'DISPID_SRGSetTextSelection',
    'DISPID_SVGetVoices', 'SpeechTokenValueCLSID',
    'ISpeechTextSelectionInformation', 'SAFT11kHz8BitMono',
    'DISPID_SRIsUISupported', 'DISPID_SRGetPropertyString',
    'DISPID_SpeechGrammarRule', 'SSFMOpenForRead',
    'SPEI_WORD_BOUNDARY', 'DISPID_SMSADeviceId', 'STCRemoteServer',
    'DISPID_SpeechLexicon', 'DISPID_SRCESoundEnd', 'SPPS_Modifier',
    'SpeechCategoryAudioIn', 'DISPID_SABufferInfo',
    'DISPID_SpeechObjectToken', 'DISPID_SPRuleName',
    'SPAUDIOBUFFERINFO', 'SPEI_VOICE_CHANGE', 'SLOStatic',
    ...
    'DISPID_SOTCEnumerateTokens', 'SVP_13', 'SVP_11', 'SINoise',
    'DISPID_SpeechLexiconProns', 'DISPID_SLGetWords',
    'DISPID_SPRulesCount', 'SpeechPropertyNormalConfidenceThreshold',
    'SPEI_UNDEFINED', 'eWORDTYPE_DELETED', 'SREPropertyStringChange',
    'SVSFlagsAsync', 'SVSFIsXML', 'SVP_10',
    'DISPID_SGRSTPropertyValue', 'ISpNotifyTranslator',
    'STSF_CommonAppData', 'SPEI_SR_PRIVATE', 'SPLOADOPTIONS',
    'SpeechEngineProperties', 'SPVPRI_OVER', 'ISpAudio',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SpeechPhraseElement',
    'DISPID_SPEAudioSizeTime', 'eLEXTYPE_RESERVED4',
    'DISPID_SLGetGenerationChange', 'DISPID_SOTCreateInstance',
    'ISpRecoGrammar', 'SPEI_REQUEST_UI', 'SPBOOKMARKOPTIONS',
    'SpeechDictationTopicSpelling', 'eLEXTYPE_LETTERTOSOUND',
    'SpeechCategoryPhoneConverters', 'SREFalseRecognition',
    'ISpLexicon', 'DISPID_SpeechVoice', 'DISPID_SRCRequestedUIType',
    'DISPID_SOTGetDescription', 'SPRST_NUM_STATES', 'SPSInterjection',
    'Speech_Default_Weight', 'ISpeechRecoResultDispatch',
    'SECFNoSpecialChars', 'DISPID_SLWLangId',
    'SPWORDPRONUNCIATIONLIST', 'SpVoice',
    'SpeechPropertyResponseSpeed', 'DISPID_SpeechGrammarRules',
    'SpeechEmulationCompareFlags', 'DISPID_SRCRetainedAudio',
    'SpeechGrammarTagDictation', 'DISPID_SRCRetainedAudioFormat',
    'SAFTText', 'SAFT48kHz16BitMono', 'SAFT44kHz8BitMono',
    'DISPID_SVSVisemeId', 'ISpeechObjectTokenCategory',
    'eLEXTYPE_PRIVATE17', 'SRTStandard',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SRSetPropertyString', 'SPCT_SUB_DICTATION',
    'DISPID_SPRDisplayAttributes', 'SP_VISEME_15', 'SITooFast',
    'SPPHRASE', 'SDTReplacement', 'eLEXTYPE_RESERVED8', 'SINone',
    'SP_VISEME_16', 'SPSEMANTICFORMAT', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SGRAttributes', 'SPSHORTCUTPAIRLIST', 'SPSHT_OTHER',
    'tagSPPROPERTYINFO', 'DISPID_SRSSupportedLanguages',
    'ISpRecoCategory', 'DISPID_SBSRead', 'DISPID_SGRSTransitions',
    'DISPID_SpeechFileStream', 'SPBO_AHEAD', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SRRAudio', 'SPWORDPRONUNCIATION', 'DISPID_SWFEChannels',
    'SpeechAudioFormatGUIDText', 'SpTextSelectionInformation',
    'SGRSTTDictation', 'DISPID_SPPsItem', 'SAFT44kHz16BitMono',
    'ISpProperties', 'SPPHRASERULE', 'SREHypothesis',
    'DISPID_SRAudioInputStream', 'SPSNoun', 'SDTRule', 'SINoSignal',
    'SPPS_SuppressWord', 'SPRST_INACTIVE', 'ISpeechLexiconWord',
    'SAFT8kHz8BitMono', 'SRATopLevel', 'SPEI_PROPERTY_NUM_CHANGE',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SPIAudioSizeTime',
    'SAFT22kHz16BitStereo', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SRGDictationLoad', 'DISPID_SRCAudioInInterferenceStatus',
    'SPVISEMES', 'SPFM_CREATE_ALWAYS', 'DISPID_SVEBookmark',
    'tagSTATSTG', 'SSTTWildcard', 'SPLO_STATIC',
    'DISPID_SRRRecoContext', 'SAFT8kHz16BitMono',
    'DISPID_SLGetPronunciations', 'SPAUDIOOPTIONS', 'SpCustomStream',
    'SAFTGSM610_11kHzMono', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SpeechRecognizer', 'DISPID_SRRSpeakAudio',
    'SSSPTRelativeToStart', 'SDKLDefaultLocation',
    'SpeechAudioVolume', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SRIsShared',
    'SpeechMicTraining', 'DISPID_SBSFormat', 'SVP_7', 'ISpShortcut',
    'SPGS_EXCLUSIVE', 'ISpeechMemoryStream', 'SPWORDLIST',
    'ISpeechPhraseReplacement', 'DISPID_SPPId', 'SGRSTTEpsilon',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SVSFIsNotXML',
    'SP_VISEME_6', 'DISPID_SWFESamplesPerSec',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SOTCDefault',
    'SpeechWordType', 'SDTDisplayText', 'SSFMCreateForWrite',
    'DISPID_SPIEngineId', 'SVP_2', 'DISPID_SOTIsUISupported',
    'SpSharedRecognizer', 'SPWT_PRONUNCIATION', 'SPFM_OPEN_READWRITE',
    'DISPID_SRCEHypothesis', 'SPAS_RUN', 'SVF_Stressed',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SLAddPronunciation',
    'DISPID_SpeechPhraseAlternate', 'SpeechVoiceEvents',
    'SP_VISEME_14', 'SPBO_NONE', 'SPWF_INPUT', 'DISPID_SVSpeakStream',
    'SVEWordBoundary', 'SPRULE', 'SPDKL_CurrentConfig', 'SPWORDTYPE',
    'DISPID_SRRTStreamTime', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SpeechDataKey', 'ISpeechDataKey', 'SPPS_Function',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SRCCreateGrammar',
    'SPAR_Low', 'ISpSerializeState', 'SPINTERFERENCE_NONE', 'SVP_9',
    'DISPID_SAEventHandle', 'SPAR_High', 'DISPID_SGRsItem',
    'DISPID_SRProfile', 'DISPID_SBSWrite',
    'SWPKnownWordPronounceable', 'SFTInput',
    'ISpeechPhraseAlternates', 'SPPS_RESERVED4', '_SPAUDIOSTATE',
    'ISpeechXMLRecoResult', 'SAFTADPCM_8kHzStereo',
    'SpUnCompressedLexicon', 'SpeechVisemeType', 'ISpRecognizer',
    'SPEI_RESERVED2', 'SDA_Two_Trailing_Spaces',
    'ISpeechPhraseInfoBuilder', 'DISPID_SVSLastResult',
    'SAFTNonStandardFormat', 'DISPID_SRCEPhraseStart',
    'DISPID_SpeechAudioStatus', 'SPAR_Unknown', 'ISpeechVoiceStatus',
    'DISPID_SRGIsPronounceable', 'SAFTADPCM_44kHzStereo', 'SWTAdded',
    'DISPID_SVEStreamEnd', 'DISPID_SRRTTickCount',
    'SpeechCategoryRecoProfiles', 'SPPHRASEREPLACEMENT',
    'DISPID_SOTGetStorageFileName', 'SpeechGrammarWordType',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SpeechAudioFormat',
    'DISPID_SPCPhoneToId', 'DISPID_SAVolume', 'SPDATAKEYLOCATION',
    'SVP_0', 'SPCT_COMMAND', 'SpeechVoicePriority',
    'SPXRO_Alternates_SML', 'SPPS_Noun', 'DISPID_SPAPhraseInfo',
    'DISPID_SRGDictationSetState', 'SpeechStreamSeekPositionType',
    'IInternetSecurityMgrSite', 'SpeechRuleState', 'DISPID_SGRSRule',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SpeechDataKeyLocation',
    'DISPID_SRStatus', 'DISPID_SpeechXMLRecoResult',
    'SDKLLocalMachine', 'SPRS_INACTIVE', 'SGSEnabled',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SGRSTWeight', 'DISPID_SPPBRestorePhraseFromMemory',
    'SRTReSent', 'SPSHT_Unknown', 'SVEBookmark',
    'ISpeechRecognizerStatus', 'DISPID_SPIStartTime', 'SP_VISEME_2',
    'SVEAllEvents', 'SVEPhoneme', 'SRESoundStart', 'SSTTTextBuffer',
    'SpeechRegistryUserRoot', 'eLEXTYPE_PRIVATE7',
    'SAFT44kHz8BitStereo', 'DISPID_SVEPhoneme', 'DISPID_SOTs_NewEnum',
    'SVP_12', 'DISPID_SVVolume', 'DISPID_SVPriority', 'SASRun',
    'SREPrivate', 'DISPID_SRCERequestUI', 'SITooSlow',
    'DISPID_SVAlertBoundary', 'SDTAll', 'DISPID_SDKSetBinaryValue',
    'SRADefaultToActive', 'DISPID_SPPConfidence',
    'DISPID_SRRPhraseInfo', 'SP_VISEME_4',
    'ISpPhoneticAlphabetSelection', 'DISPID_SVWaitUntilDone',
    'DISPID_SGRSTsItem', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRCEFalseRecognition', 'DISPID_SPIElements', 'SITooQuiet',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SPEAudioSizeBytes',
    'SAFTDefault', 'SpeechAllElements', 'SPPS_RESERVED2',
    'DISPID_SDKEnumKeys', 'eLEXTYPE_RESERVED9', 'SpeechAudioState',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SP_VISEME_17',
    'SAFTCCITT_uLaw_8kHzStereo', 'SVP_3', 'DISPID_SPELexicalForm'
]

_check_version('1.3.0', 1699658952.995067)

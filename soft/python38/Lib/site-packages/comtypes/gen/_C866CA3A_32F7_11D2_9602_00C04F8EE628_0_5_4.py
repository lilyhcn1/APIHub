...
__all__ = [
    'DISPID_SDKDeleteKey', 'SVP_1', 'DISPID_SpeechPhraseAlternate',
    'SVSFParseMask', 'SPEI_RESERVED3', 'SRCS_Enabled',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SpeechLexicon',
    'ISpRecognizer2', 'DISPID_SRSCurrentStreamNumber',
    'SPWORDPRONUNCIATION', 'DISPID_SpeechBaseStream', 'SGDSActive',
    'SVESentenceBoundary', 'SPDATAKEYLOCATION', 'SPRECOGNIZERSTATUS',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SDKSetBinaryValue',
    'DISPID_SpeechRecoResult', 'SPDKL_CurrentUser', 'SPBO_TIME_UNITS',
    'SpeechVoiceEvents', 'DISPID_SPRuleParent',
    'SpeechRegistryUserRoot', 'SPAS_CLOSED', 'SpPhraseInfoBuilder',
    'SDTPronunciation', 'SpeechRecoContextState',
    'DISPID_SpeechRecoContext', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SPRText', 'SITooLoud', 'ISpeechAudioBufferInfo',
    'DISPID_SOTsCount', 'SPEI_RECO_OTHER_CONTEXT',
    'ISpeechAudioStatus', 'SP_VISEME_0',
    'DISPID_SPANumberOfElementsInResult', 'SP_VISEME_15',
    'DISPID_SGRName', 'SpeechRecognizerState', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SGRSTransitions', 'DISPID_SLGetWords',
    'DISPID_SRDisplayUI', 'DISPID_SRCEAdaptation',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRCEPhraseStart',
    'DISPID_SPERetainedStreamOffset', 'SPCT_SLEEP', 'SPWT_LEXICAL',
    'SVF_Stressed', 'DISPID_SLPs_NewEnum', 'DISPID_SLGenerationId',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SpeechPhraseProperties',
    'DISPID_SpeechGrammarRules', 'DISPID_SRCRequestedUIType',
    'SPBO_PAUSE', 'SP_VISEME_8', 'SPSTREAMFORMATTYPE',
    'DISPID_SOTDataKey',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpeechPhraseReplacements', 'DISPID_SABufferNotifySize',
    'SAFT32kHz8BitStereo', 'SVSFNLPSpeakPunc',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SVSpeakCompleteEvent',
    'SAFTCCITT_uLaw_22kHzMono', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SPRuleName', 'SDTAll', 'DISPID_SAEventHandle',
    'SPSERIALIZEDRESULT', 'SDA_One_Trailing_Space', 'SPEI_MAX_TTS',
    'DISPID_SGRSTNextState', 'SDTLexicalForm', 'SpeechVisemeFeature',
    'DISPID_SPIGetText', 'SVEWordBoundary',
    'DISPID_SPRuleFirstElement', 'SREAudioLevel',
    'DISPID_SPPFirstElement', 'DISPID_SRGetRecognizers',
    'ISpeechPhraseReplacement', 'SpResourceManager',
    'DISPID_SRGSetWordSequenceData', 'eLEXTYPE_PRIVATE18',
    'DISPID_SPIGetDisplayAttributes',
    'DISPID_SGRSAddSpecialTransition', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SRCERequestUI', 'SVSFVoiceMask', 'DISPID_SRRSpeakAudio',
    'SBONone', 'SVEAudioLevel', 'SAFT12kHz8BitStereo',
    'DISPID_SVEPhoneme', 'DISPID_SVESentenceBoundary',
    'DISPID_SGRsCommit', 'SPBOOKMARKOPTIONS', 'SPGRAMMARWORDTYPE',
    'SRERecognition', 'SRSActive', 'SRSEIsSpeaking',
    'DISPID_SPRFirstElement', 'DISPID_SRCEventInterests',
    '_RemotableHandle', 'DISPID_SRGSetTextSelection',
    'DISPID_SBSFormat', 'DISPID_SpeechDataKey', 'SpLexicon',
    'SpeechDisplayAttributes', 'DISPID_SVSLastBookmark',
    'SpeechTokenKeyUI', 'SP_VISEME_13',
    'DISPID_SRCEPropertyNumberChange', 'SVF_Emphasis', 'SLTUser',
    'SFTSREngine', 'DISPID_SRGDictationLoad', 'DISPID_SMSADeviceId',
    'SP_VISEME_20', 'SPSNoun', 'SPPS_Noncontent', 'DISPID_SGRSTText',
    'SP_VISEME_1', 'eLEXTYPE_PRIVATE7', 'SRESoundEnd',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SRRTimes',
    'DISPID_SRCESoundStart', 'SVP_8', 'SpeechTokenValueCLSID',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SWFEBitsPerSample',
    'SDTDisplayText', 'DISPID_SGRsFindRule', 'SpPhoneConverter',
    'DISPID_SPEAudioSizeTime', 'SPGS_DISABLED',
    'SPEI_PROPERTY_NUM_CHANGE', 'SpeechTokenKeyAttributes',
    'DISPID_SPPs_NewEnum', 'SAFT22kHz8BitStereo',
    'SpNotifyTranslator', 'SASRun', 'DISPID_SVPriority',
    'SPEI_RESERVED2', 'DISPID_SRRTTickCount',
    'SPEI_START_INPUT_STREAM', 'SPEI_RESERVED5', 'SVP_17',
    'SpeechVisemeType', 'SPAUDIOOPTIONS', 'DISPID_SPRsItem',
    'DISPID_SPRs_NewEnum', 'SAFTCCITT_ALaw_22kHzStereo',
    'SP_VISEME_10', 'SPINTERFERENCE_TOOQUIET', 'SP_VISEME_9',
    'SPSMF_SAPI_PROPERTIES', 'SPEI_VOICE_CHANGE',
    'DISPID_SRCEPropertyStringChange', 'SPDKL_CurrentConfig',
    'SPBINARYGRAMMAR', 'ISpRecoContext', 'DISPID_SASState',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPEI_SOUND_END',
    'SAFTADPCM_44kHzMono', 'SpPhoneticAlphabetConverter', 'SPBO_NONE',
    'DISPID_SOTs_NewEnum', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SOTCId', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPWORDLIST',
    'SAFTText', 'SPSEMANTICFORMAT', 'SPAO_RETAIN_AUDIO',
    'SPGS_ENABLED', 'ISpeechDataKey', 'SSTTWildcard',
    'DISPID_SADefaultFormat', 'SDTRule', 'DISPID_SPARecoResult',
    ...
    'SPEI_START_SR_STREAM', 'SRCS_Disabled', 'SpeechBookmarkOptions',
    'SP_VISEME_5', 'SVP_7', 'DISPID_SPRuleEngineConfidence',
    'ISpeechRecoResult', 'DISPID_SBSRead', 'STSF_LocalAppData',
    'SGPronounciation', 'DISPID_SVSInputWordLength', 'DISPID_SPPName',
    'SVP_13', 'SpeechAudioFormatGUIDText', 'DISPID_SGRSTRule',
    'ISpeechPhraseRules', 'SGLexicalNoSpecialChars', 'SP_VISEME_7',
    'SVSFNLPMask', 'ISpeechMemoryStream', 'eLEXTYPE_PRIVATE11',
    'SPEI_UNDEFINED', 'ISpeechRecoResultTimes', 'SpVoice',
    'SpeechAllElements', 'ISpPhraseAlt', 'SGSEnabled',
    'DISPID_SPIElements', 'SAFT22kHz16BitMono',
    'DISPID_SREmulateRecognition', 'SpCompressedLexicon',
    'DISPID_SWFEFormatTag', 'SVEPrivate', 'DISPID_SLPPhoneIds',
    'SREAllEvents', 'SPXRO_Alternates_SML',
    'DISPID_SRGCmdLoadFromFile', 'SPSLMA', 'Speech_Max_Pron_Length',
    'ISpRecognizer', 'SREStreamEnd', 'SAFT44kHz16BitMono',
    'SAFTADPCM_11kHzMono', 'DISPID_SPAsItem', 'DISPID_SPRulesCount',
    'DISPID_SRGState', 'SSTTTextBuffer',
    'DISPID_SRCEFalseRecognition', 'SAFTCCITT_uLaw_8kHzMono',
    'ISpRecoResult', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SpeechLexiconPronunciation', 'SAFTADPCM_8kHzMono',
    'DISPID_SPRules_NewEnum', 'DISPID_SpeechLexiconWord',
    'SWPUnknownWordPronounceable', 'SpeechRecoEvents',
    'eLEXTYPE_LETTERTOSOUND', '_SPAUDIOSTATE', 'SVPNormal',
    'ISpeechObjectTokenCategory', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SWFEBlockAlign', 'SPPS_SuppressWord', 'SpWaveFormatEx',
    'SPPS_RESERVED2', 'SPEI_END_SR_STREAM', 'SPWORD',
    'DISPID_SVVoice', 'SDKLCurrentConfig', 'SPPS_Function', 'SVP_18',
    'SpeechRecoProfileProperties', 'ISpeechPhoneConverter',
    'ISpPhoneticAlphabetConverter', 'SRADefaultToActive',
    'DISPID_SPPNumberOfElements', 'ISpeechMMSysAudio',
    'ISpeechTextSelectionInformation', 'SGSExclusive',
    'DISPID_SRGetPropertyString', 'SPSEMANTICERRORINFO',
    'SpeechRunState', 'SECHighConfidence',
    'DISPID_SPIEnginePrivateData', 'SRTReSent',
    'SAFTGSM610_22kHzMono', 'SGDisplay', 'SAFT48kHz16BitStereo',
    'DISPID_SpeechPhraseAlternates', 'SDTReplacement',
    'DISPID_SpeechPhraseElements', 'SPEI_RESERVED1',
    'STCInprocHandler', 'SRAONone', 'DISPID_SRRAlternates', 'SVP_5',
    'DISPID_SPPConfidence', 'DISPID_SPIEngineId',
    'DISPID_SOTCategory', 'DISPID_SVGetAudioInputs',
    'SpeechCategoryPhoneConverters', 'SpeechAudioState', 'Library',
    'DISPID_SLPsItem', 'DISPID_SGRSTsCount',
    'SpTextSelectionInformation', 'ISpeechLexiconWord', 'SPRULE',
    'SPCS_DISABLED', 'LONG_PTR', 'SRERecoOtherContext',
    'SAFTCCITT_ALaw_44kHzMono', 'typelib_path', 'DISPID_SPPValue',
    'SPEI_TTS_AUDIO_LEVEL', 'SVP_4', 'SPEVENTSOURCEINFO',
    'DISPID_SPPEngineConfidence', 'DISPID_SpeechAudioFormat',
    'SPVPRI_OVER', 'DISPID_SPCPhoneToId', 'SPPHRASEELEMENT',
    'SAFTCCITT_uLaw_44kHzStereo', 'SGRSTTWord', 'SRADynamic',
    'DISPID_SABIMinNotification', 'SPFM_CREATE_ALWAYS',
    'DISPIDSPTSI_ActiveOffset', 'eLEXTYPE_PRIVATE10',
    'ISpeechGrammarRuleState', 'DISPID_SOTGetStorageFileName',
    'DISPID_SOTRemove', 'DISPID_SLWs_NewEnum',
    'DISPID_SPIAudioSizeBytes', 'SpObjectToken', 'eWORDTYPE_DELETED',
    'SRTExtendableParse', 'DISPID_SMSALineId',
    'DISPIDSPTSI_SelectionOffset', 'SPAR_Medium',
    'DISPID_SRCRetainedAudio', 'ISpRecognizer3', 'ISpStream',
    'SVP_16', 'DISPID_SVVolume', 'SpeechEmulationCompareFlags',
    'DISPID_SBSSeek', 'DISPID_SOTMatchesAttributes',
    'DISPID_SRCEEnginePrivate', 'DISPID_SPEsItem', 'ISpShortcut',
    'SpMMAudioIn', 'SPWORDTYPE', 'ISpNotifySource',
    'DISPID_SRRecognizer', 'SAFTADPCM_44kHzStereo',
    'SAFT16kHz8BitStereo', 'DISPID_SVSLastBookmarkId',
    'SPLEXICONTYPE', 'SPSUnknown', 'SREAdaptation',
    'SAFTNoAssignedFormat', 'DISPID_SPCIdToPhone',
    'SAFTADPCM_22kHzStereo', 'SPSHT_Unknown', 'SpeechDiscardType',
    'DISPID_SDKSetLongValue', 'SAFT32kHz16BitMono',
    'DISPID_SpeechRecognizer', 'STSF_CommonAppData', 'DISPID_SVEWord',
    'eLEXTYPE_RESERVED8', 'DISPID_SRGetFormat', 'SPPS_NotOverriden',
    'SVSFPurgeBeforeSpeak', 'SP_VISEME_18',
    'DISPID_SpeechPhraseProperty', 'SPEI_MIN_SR',
    'Speech_StreamPos_RealTime', 'DISPID_SGRsCount',
    'DISPID_SGRSTPropertyValue', 'ISpResourceManager',
    'DISPID_SLWLangId', 'DISPID_SGRSTsItem', 'SPAUDIOSTATE',
    'DISPID_SRIsShared', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SOTCGetDataKey', 'DISPID_SRCESoundEnd', 'SPWF_SRENGINE',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SVP_12', 'ISpeechObjectTokens',
    'DISPID_SPRuleConfidence', 'DISPID_SpeechRecoResult2',
    'SITooFast', 'DISPID_SVGetAudioOutputs', 'eLEXTYPE_USER',
    'SpeechAudioVolume', 'SpeechPropertyNormalConfidenceThreshold',
    'SPINTERFERENCE_TOOLOUD', 'SVSFParseAutodetect', 'DISPID_SVPause',
    'DISPID_SVDisplayUI', 'SRAORetainAudio', 'ISpeechPhraseAlternate',
    'DISPID_SOTCreateInstance', 'DISPID_SOTId',
    'DISPID_SRCreateRecoContext', 'DISPID_SLPsCount',
    'ISpeechObjectToken', 'DISPID_SPAStartElementInResult',
    'SPSHT_NotOverriden', 'SPRECOSTATE', 'SpeechMicTraining',
    'DISPID_SpeechPhraseRule', 'SPFM_OPEN_READWRITE',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SDKCreateKey',
    'SWTAdded', 'SPEI_HYPOTHESIS', 'DISPID_SRSClsidEngine',
    'SAFT16kHz8BitMono', 'SSFMOpenForRead', 'SDA_No_Trailing_Space',
    'SpeechTokenKeyFiles', 'DISPID_SPIRule', 'SGSDisabled',
    'SVEBookmark', 'SPEI_VISEME', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SOTsItem', 'DISPID_SGRSTs_NewEnum', 'DISPID_SWFEChannels',
    'DISPID_SRSSupportedLanguages', 'SpStreamFormatConverter',
    'DISPID_SpeechPhraseRules', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SVEventInterests', 'SVSFParseSsml',
    'DISPID_SRGCmdLoadFromResource', 'SDTProperty',
    'DISPID_SVEAudioLevel', 'SINone',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPERequiredConfidence', 'ISpObjectToken',
    'DISPID_SPRDisplayAttributes', 'SPEI_REQUEST_UI', 'SPSModifier',
    'STCRemoteServer', 'SVP_6', 'DISPID_SPEsCount',
    'ISpeechLexiconPronunciation', 'ISpeechPhraseRule',
    'DISPID_SMSAMMHandle', 'eLEXTYPE_USER_SHORTCUT', 'SDTAudio',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRRTLength',
    'eLEXTYPE_PRIVATE15', 'SREFalseRecognition',
    'DISPID_SGRs_NewEnum', 'SPEVENT', 'SP_VISEME_16', 'SVPOver',
    'DISPID_SRCSetAdaptationData', 'eLEXTYPE_RESERVED4',
    'DISPID_SOTIsUISupported', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpeechVoiceCategoryTTSRate', 'SSSPTRelativeToEnd',
    'DISPID_SRCEBookmark', 'SpCustomStream', 'SPEI_INTERFERENCE',
    'SSTTDictation', 'DISPID_SRCEStartStream',
    'SpeechPropertyResponseSpeed', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRRGetXMLResult', 'SITooQuiet', 'DISPID_SVSPhonemeId',
    'SPCT_COMMAND', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SpeechRecognizerStatus', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SVStatus', 'SDKLLocalMachine', 'SRTEmulated',
    'SAFTDefault', 'SAFT11kHz8BitMono', 'ISpPhrase',
    'SPDKL_DefaultLocation', 'DISPID_SRGCmdLoadFromMemory',
    'SPPS_Unknown', 'DISPID_SVSInputSentenceLength',
    'DISPID_SpeechCustomStream', 'SPSMF_UPS', 'SAFT11kHz8BitStereo',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SOTCSetId',
    'DISPID_SRGCmdSetRuleIdState', 'SP_VISEME_12', 'DISPID_SFSOpen',
    'DISPID_SVEStreamStart', 'DISPID_SDKOpenKey', 'SPEVENTENUM',
    'WAVEFORMATEX', 'SAFTGSM610_44kHzMono', 'SPINTERFERENCE_NONE',
    'SVSFIsXML', 'SVSFPersistXML', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPPROPERTYINFO', 'DISPID_SRGCommit',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SpeechLexiconProns',
    'SpSharedRecoContext', 'SP_VISEME_2', 'SPLO_STATIC',
    'SECFDefault', 'SPFM_OPEN_READONLY', 'SVF_None', 'SVSFlagsAsync',
    'SPRS_ACTIVE', 'SAFT16kHz16BitStereo', 'SAFT48kHz16BitMono',
    'SpNullPhoneConverter', 'SPEI_SR_BOOKMARK',
    'SSSPTRelativeToStart', 'DISPID_SGRId', 'eLEXTYPE_PRIVATE4',
    'ISpeechResourceLoader', 'ISpeechPhraseElement',
    'DISPID_SpeechObjectTokens', 'SAFTCCITT_uLaw_44kHzMono',
    'SPCT_SUB_COMMAND', 'DISPID_SpeechGrammarRuleStateTransition',
    'SAFTCCITT_ALaw_22kHzMono', 'SPRST_ACTIVE_ALWAYS',
    'SpeechCategoryRecoProfiles', 'DISPID_SLPSymbolic',
    'SP_VISEME_19', 'ISpeechRecoResult2', 'SPINTERFERENCE',
    'SGRSTTDictation', 'ISpeechWaveFormatEx', 'DISPID_SLWsCount',
    'ISpeechFileStream', 'SDTAlternates', 'SPCATEGORYTYPE',
    'ISequentialStream', 'eWORDTYPE_ADDED', 'ISpAudio',
    'DISPID_SDKSetStringValue', 'SAFTADPCM_22kHzMono',
    'DISPID_SRSetPropertyNumber', 'SAFT48kHz8BitMono', 'SASClosed',
    'DISPID_SLAddPronunciation', 'SRTSMLTimeout', 'ISpNotifySink',
    'DISPID_SRCCreateGrammar', 'SREPhraseStart', 'SRSInactive',
    'DISPID_SVWaitUntilDone', 'DISPID_SPPChildren',
    'eLEXTYPE_PRIVATE5', 'SPPS_Verb', 'eLEXTYPE_PRIVATE17',
    'SPEI_SR_PRIVATE', 'DISPID_SPEEngineConfidence',
    'DISPID_SpeechVoice', 'ISpeechRecoContext', 'SpMemoryStream',
    'ISpMMSysAudio', 'SAFT22kHz16BitStereo', 'SP_VISEME_11',
    'SAFT8kHz16BitMono', 'eLEXTYPE_APP', 'DISPID_SRSAudioStatus',
    'SASStop', 'DISPID_SAFGetWaveFormatEx', 'SPINTERFERENCE_TOOFAST',
    'ISpeechAudio', 'DISPID_SRStatus', 'SVP_20',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SDKDeleteValue',
    'IEnumSpObjectTokens', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SpeechVoiceStatus', 'ISpeechLexiconPronunciations',
    'DISPID_SPAs_NewEnum', 'DISPID_SOTRemoveStorageFileName',
    'eLEXTYPE_PRIVATE2', 'eLEXTYPE_PRIVATE20', 'DISPID_SVEStreamEnd',
    'DISPID_SASNonBlockingIO', 'DISPID_SRProfile',
    'DISPID_SVGetVoices', 'DISPID_SDKGetStringValue',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRAudioInput',
    'STCInprocServer', 'DISPID_SRCRecognizer', 'SAFT24kHz16BitMono',
    'DISPID_SpeechVoiceEvent', 'tagSPPROPERTYINFO',
    'DISPID_SRGCmdSetRuleState', 'UINT_PTR', 'SLOStatic', 'SVP_9',
    'DISPID_SpeechMemoryStream', 'SAFT11kHz16BitMono',
    'STCLocalServer', 'SRARoot', 'SPEI_RECO_STATE_CHANGE',
    'SPAUDIOSTATUS', 'SAFT44kHz8BitMono', 'SVEStartInputStream',
    'SGRSTTWildcard', 'SAFT11kHz16BitStereo', 'DISPID_SRCEHypothesis',
    'DISPID_SVSVisemeId', 'ISpDataKey', 'SpeechTokenContext',
    'DISPID_SPRNumberOfElements', 'DISPID_SRState', 'SPLO_DYNAMIC',
    'DISPID_SOTCDefault', 'DISPID_SGRInitialState',
    'SPEI_RECOGNITION', 'SPEI_WORD_BOUNDARY',
    ...
    'ISpObjectTokenCategory', 'DISPID_SLWType', 'SPPS_Noun',
    'DISPID_SpeechPhraseInfo', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SpeechRecoResultTimes', 'SPCT_DICTATION',
    'SAFT24kHz8BitStereo', 'ISpeechPhraseInfo', 'SPPS_RESERVED3',
    'SECFEmulateResult', 'SpeechCategoryVoices', 'STCAll',
    'SpeechLexiconType', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SPISaveToMemory', 'SPAUDIOBUFFERINFO', 'STSF_FlagCreate',
    'SECFIgnoreCase', 'SPAO_NONE', 'SpeechWordPronounceable',
    'DISPID_SPPsCount', 'SPFM_NUM_MODES', '_ISpeechVoiceEvents',
    'SREHypothesis', 'DISPID_SRGRecoContext', 'SLODynamic',
    'eLEXTYPE_PRIVATE13', 'SpMMAudioEnum',
    'DISPID_SRAudioInputStream', 'SPRST_INACTIVE_WITH_PURGE',
    'SSFMCreateForWrite', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SGRClear', 'SpeechCategoryAudioOut', 'eLEXTYPE_PRIVATE14',
    ...
    'DISPID_SPAPhraseInfo', 'SPSSuppressWord', 'SECNormalConfidence',
    'SDKLCurrentUser', 'SPSHT_EMAIL', 'DISPID_SPRuleId',
    'SPEI_END_INPUT_STREAM', 'SPPS_Modifier', 'DISPID_SPPId',
    'SpeechPartOfSpeech', 'Speech_Max_Word_Length', 'SVSFUnusedFlags',
    'DISPID_SGRSTPropertyId', 'SPAS_RUN', 'SVP_3', 'SVP_14',
    'DISPID_SAStatus', 'ISpRecoGrammar2', 'SRESoundStart',
    'DISPID_SVSLastResult', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SVEVoiceChange', 'SPAR_High', 'SPRS_INACTIVE',
    'SPPS_RESERVED4', 'SPPHRASERULE', 'DISPID_SPRulesItem',
    'DISPID_SWFEExtraData', 'SVP_19', 'DISPID_SRRRecoContext',
    'SpeechAudioFormatType', 'IInternetSecurityMgrSite',
    'DISPID_SRCEAudioLevel', 'SpInprocRecognizer',
    'DISPID_SPRuleChildren', 'SGDSActiveWithAutoPause',
    'SREStateChange', 'eLEXTYPE_RESERVED10',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SASetState',
    'ISpeechPhraseAlternates', 'DISPID_SVSyncronousSpeakTimeout',
    'SWTDeleted', 'DISPID_SPEs_NewEnum', 'SVP_11',
    'SpeechDataKeyLocation', 'SECFIgnoreWidth',
    'DISPID_SVSInputSentencePosition', 'SBOPause',
    'SAFT12kHz16BitStereo', 'DISPID_SDKGetBinaryValue',
    'DISPID_SRCResume', 'DISPID_SGRSTWeight', 'eLEXTYPE_RESERVED6',
    'SRSEDone', 'DISPID_SOTGetDescription', 'SPWT_PRONUNCIATION',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPRULESTATE',
    'ISpeechLexiconWords', 'SAFT24kHz8BitMono', 'SPRST_ACTIVE',
    'DISPID_SOTSetId', 'SPCONTEXTSTATE', 'SpeechCategoryRecognizers',
    'SpeechStreamSeekPositionType', 'DISPID_SpeechPhraseReplacements',
    'SPSVerb', 'DISPID_SGRsAdd', 'SDA_Two_Trailing_Spaces',
    'SpeechGrammarTagWildcard', 'DISPID_SMSSetData', 'SRAInterpreter',
    'ISpObjectWithToken', 'SpeechVoicePriority', 'SFTInput',
    'SP_VISEME_3', 'eLEXTYPE_PRIVATE16', 'SVP_21',
    'eLEXTYPE_PRIVATE3', 'SpeechTokenIdUserLexicon',
    'SPADAPTATIONRELEVANCE', 'DISPID_SRRTStreamTime',
    'DISPID_SLWsItem', 'DISPID_SRCState', 'DISPID_SRGDictationUnload',
    'DISPID_SPACommit', 'SVP_2', 'DISPIDSPTSI_SelectionLength',
    'SPWORDPRONOUNCEABLE', 'DISPID_SCSBaseStream',
    'SpeechGrammarWordType', 'ISpeechBaseStream',
    'SPSERIALIZEDPHRASE', 'DISPID_SGRAddState', 'SRSActiveAlways',
    'eLEXTYPE_RESERVED7', 'SVP_0', 'DISPID_SOTGetAttribute',
    'Speech_StreamPos_Asap', 'SRTStandard',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPSInterjection', 'SVEAllEvents',
    'DISPID_SAFType', 'DISPID_SRGId', 'SpeechAddRemoveWord',
    'DISPID_SLPPartOfSpeech', 'SPSHORTCUTPAIR',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SLGetPronunciations', 'DISPID_SABIEventBias',
    'SECFNoSpecialChars', 'DISPID_SpeechPhraseElement',
    'SPGRAMMARSTATE', 'DISPID_SFSClose', 'SPWF_INPUT', 'SVEViseme',
    'IEnumString', 'SPSHORTCUTPAIRLIST', 'SRSInactiveWithPurge',
    'eLEXTYPE_PRIVATE9', 'DISPID_SpeechFileStream',
    'SAFT48kHz8BitStereo', 'ISpeechPhraseInfoBuilder',
    'DISPID_SPILanguageId', 'SpShortcut', 'SAFTGSM610_8kHzMono',
    'DISPID_SPELexicalForm', 'SPEI_RESERVED6', 'SVP_15',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPEI_MIN_TTS', 'SP_VISEME_14',
    'SpeechSpecialTransitionType', 'DISPID_SDKGetlongValue',
    'SVSFIsNotXML', 'SSFMCreate', 'SPWAVEFORMATTYPE', 'SPPHRASE',
    'eLEXTYPE_PRIVATE19', 'ISpeechRecognizerStatus',
    'DISPID_SPEAudioStreamOffset', 'SPEI_TTS_PRIVATE', 'SPPS_LMA',
    'DISPID_SVIsUISupported', 'ISpeechPhraseProperties',
    'ISpRecoGrammar', 'DISPID_SPIGrammarId', 'SPEI_MAX_SR',
    'SINoSignal', 'SpeechLoadOption', 'SPAS_STOP',
    'eLEXTYPE_PRIVATE8', 'DISPID_SVSkip', 'eLEXTYPE_RESERVED9',
    'SVSFIsFilename', 'SPEI_TTS_BOOKMARK', 'SAFT8kHz8BitMono',
    'SpeechInterference', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SpeechFormatType', 'SpeechRuleAttributes', 'DISPID_SRRAudio',
    ...
    'DISPID_SABIBufferSize', 'SVP_10', 'SRAImport',
    'DISPID_SRRDiscardResultInfo', 'SSFMOpenReadWrite',
    'SpeechAudioFormatGUIDWave', 'ISpeechXMLRecoResult',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPEAudioSizeBytes', 'SPRECOCONTEXTSTATUS',
    'DISPID_SLPType', 'SRTAutopause', 'DISPID_SASCurrentSeekPosition',
    'SpeechCategoryAppLexicons', 'tagSTATSTG',
    'SGDSActiveUserDelimited', 'DISPID_SRSNumberOfActiveRules',
    'SGDSInactive', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRIsUISupported', 'DISPID_SVAudioOutput', 'SPFILEMODE',
    'ISpRecoContext2', 'SPPS_RESERVED1', 'SPXMLRESULTOPTIONS',
    'DISPID_SGRSTPropertyName', 'SpeechWordType',
    'DISPID_SpeechAudio', 'SpeechPropertyResourceUsage',
    'eLEXTYPE_PRIVATE1', 'DISPID_SVSpeakStream',
    'SAFTNonStandardFormat', 'ISpPhoneConverter',
    'SAFT16kHz16BitMono', 'DISPID_SRGReset',
    'DISPID_SpeechPhoneConverter', 'DISPID_SPEAudioTimeOffset',
    'ISpStreamFormatConverter', 'SPPHRASEPROPERTY',
    'SWPUnknownWordUnpronounceable', 'DISPID_SGRsItem', 'SRAExport',
    'SVPAlert', 'DISPID_SPEPronunciation', 'SAFTCCITT_ALaw_8kHzMono',
    'SASPause', 'DISPID_SVRate', 'DISPID_SGRAddResource',
    'DISPID_SPIProperties', 'SPVOICESTATUS', 'SPAR_Unknown',
    '_ISpeechRecoContextEvents', 'SpAudioFormat', 'SREPrivate',
    'DISPID_SVEBookmark', 'DISPID_SRCEInterference',
    'SAFTCCITT_uLaw_22kHzStereo', 'IInternetSecurityManager',
    'SPINTERFERENCE_TOOSLOW', 'SECFIgnoreKanaType',
    'ISpeechRecognizer', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRRAudioFormat', 'ISpStreamFormat', 'DISPID_SPPsItem',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPBO_AHEAD',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SGRSAddWordTransition',
    'SPSFunction', 'SAFT8kHz8BitStereo',
    ...
    'STSF_AppData', 'SpSharedRecognizer', 'DISPID_SDKEnumKeys',
    'SPXRO_SML', 'SpeechEngineProperties', 'SpInProcRecoContext',
    'SPDKL_LocalMachine', 'DISPID_SLRemovePronunciation',
    'DISPID_SLWWord', 'SDKLDefaultLocation', 'DISPID_SPIStartTime',
    'SVEEndInputStream', 'SAFT12kHz16BitMono', 'DISPID_SVResume',
    'SPAS_PAUSE', 'SpeechPropertyAdaptationOn', 'SPRST_NUM_STATES',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SpeechMMSysAudio',
    'SPCS_ENABLED', 'DISPID_SRCEEndStream',
    'DISPID_SRSetPropertyString', 'DISPID_SpeechAudioStatus',
    'ISpeechPhraseProperty', 'DISPID_SVGetProfiles',
    'SREPropertyNumChange', 'DISPID_SVEViseme', 'SREBookmark',
    'SPRST_INACTIVE', 'DISPID_SRRPhraseInfo',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechGrammarRules', 'DISPID_SRCVoice', 'DISPID_SPAsCount',
    'SPRECORESULTTIMES', 'SAFTADPCM_11kHzStereo',
    'DISPID_SpeechPhraseBuilder', 'SpStream', 'ISpVoice',
    'DISPID_SPEDisplayText', 'SREPropertyStringChange',
    'SAFT8kHz16BitStereo', 'Speech_Default_Weight', 'SPWT_DISPLAY',
    'SpeechGrammarTagDictation', 'DISPID_SpeechGrammarRuleState',
    'SpeechRecognitionType', 'DISPID_SpeechLexiconWords',
    'DISPID_SLPLangId', 'DISPID_SRGIsPronounceable', 'DISPID_SVSpeak',
    'SPEI_PHRASE_START', 'SGRSTTEpsilon', 'SP_VISEME_4',
    'eLEXTYPE_PRIVATE6', 'SpeechTokenShellFolder',
    'ISpeechGrammarRule', 'SPEI_ADAPTATION',
    'DISPID_SRRSetTextFeedback', 'SpeechAudioProperties',
    'SpFileStream', 'SAFT22kHz8BitMono', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SASFreeBufferSpace', 'DISPID_SVAlertBoundary',
    ...
    'SpMMAudioOut', 'SAFT24kHz16BitStereo', 'SREStreamStart',
    'SITooSlow', 'DISPID_SGRSTType', 'SRATopLevel',
    'DISPID_SRCRetainedAudioFormat', 'ISpeechVoice',
    'SPPHRASEREPLACEMENT', 'SpUnCompressedLexicon', 'SPGS_EXCLUSIVE',
    'SPAR_Low', 'SDA_Consume_Leading_Spaces',
    'DISPID_SpeechRecoContextEvents', 'SP_VISEME_6',
    'DISPID_SRCERecognition', 'DISPID_SPIReplacements',
    'SAFT32kHz8BitMono', 'DISPID_SVEEnginePrivate',
    'DISPID_SPCLangId', 'DISPID_SPPParent',
    'DISPID_SpeechGrammarRule', 'ISpGrammarBuilder',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPIDSPTSI', 'DISPID_SBSWrite',
    'SPINTERFERENCE_NOSIGNAL', 'SPLOADOPTIONS',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SRGCmdLoadFromObject',
    'ISpeechLexicon', 'SP_VISEME_17', 'SpeechEngineConfidence',
    'DISPID_SMSGetData', 'SpeechStreamFileMode', 'ISpSerializeState',
    'ISpProperties', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechCategoryAudioIn', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SAVolume', 'DISPID_SRRSaveToMemory', 'ISpeechRecoGrammar',
    'SPSHT_OTHER', 'DISPID_SGRsDynamic', 'DISPID_SLWPronunciations',
    'SPINTERFERENCE_NOISE', 'SPVPRI_NORMAL', 'SPCT_SUB_DICTATION',
    'SINoise', 'SLTApp', 'SPVISEMES', 'DISPID_SOTDisplayUI',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SABufferInfo',
    'SVEVoiceChange', 'SPEI_SOUND_START',
    'ISpPhoneticAlphabetSelection', 'SpeechUserTraining',
    'SPVPRIORITY', 'SAFT32kHz16BitStereo', 'IStream', 'SVSFDefault',
    'ISpLexicon', 'SWPKnownWordPronounceable', 'SpeechRuleState',
    'SPEI_SR_RETAINEDAUDIO', 'SGRSTTRule', 'SAFTADPCM_8kHzStereo',
    'SVSFParseSapi', 'ISpRecoCategory', 'SVEPhoneme', 'SPFM_CREATE',
    'SPPS_Interjection', 'DISPIDSPRG', 'SECLowConfidence',
    'SRERequestUI', 'DISPID_SVAudioOutputStream', 'DISPID_SAFGuid',
    'SPEI_PHONEME', 'DISPID_SRGetPropertyNumber', 'SP_VISEME_21',
    'SREInterference', 'SPSNotOverriden', 'DISPID_SRCBookmark',
    'DISPID_SVSRunningState', 'SGRSTTTextBuffer', 'ISpEventSource',
    'SGLexical', 'SPPARTOFSPEECH', 'DISPID_SGRAttributes',
    'DISPID_SPRsCount', 'SpeechRetainedAudioOptions',
    'DISPID_SLGetGenerationChange', 'ISpXMLRecoResult',
    'DISPID_SRCPause', 'SAFTExtendedAudioFormat', 'DISPID_SRGRules',
    'DISPID_SPIAudioSizeTime', 'SpeechPropertyComplexResponseSpeed',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPVPRI_ALERT',
    'SAFT44kHz8BitStereo', 'DISPID_SPEActualConfidence',
    'ISpeechGrammarRuleStateTransitions'
]

_check_version('1.3.0', 1679918888.079131)
